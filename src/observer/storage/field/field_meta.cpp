...
FieldMeta::FieldMeta() : attr_type_(AttrType::UNDEFINED), attr_offset_(-1), attr_len_(0),
                            visible_(false), field_id_(0) {}

FieldMeta::FieldMeta(const char *name, AttrType attr_type, int attr_offset, int attr_len, 
                            bool visible, int field_id, bool nullable)
{
                                        ...
                                        bool visible, int field_id, bool nullable)
{
  ...
  LOG_INFO("Init a field with name=%s, nullable=%s", name, nullable ? "true" : "false");
  return RC::SUCCESS;
}
